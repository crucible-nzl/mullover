...
| 2.6 | Cancel renewal | n/a · per-decision only | Consumer Annual was retired 2026-05-25; there are no consumer subscriptions to cancel. Webhook still defensively accepts `customer.subscription.*` events for any legacy holder. | n/a |
| 2.7 | Change plan / SKU | /pricing checkout flow | New checkout = new one-time payment. Three live SKUs (solo_paid, couple, family). | ✅ Implemented |
